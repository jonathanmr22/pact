...
- **Skill discovery + enforcement hook pair** — Two new hooks that close the gap between "skill exists in `_SKILL_INDEX.yaml`" and "agent actually follows it."
