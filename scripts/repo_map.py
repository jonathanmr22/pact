...
# PACT-as-a-project (dogfooding): point at PACT's own structure.
# This is the local-to-PACT copy used to generate the demo dashboard
# screenshot. The template version (templates/scripts/repo_map.py) keeps
# the original-use-case defaults as a real-world reference.
INCLUDE_DIRS = ["templates", "plugins", "scripts", "docs"]
